CREATE TABLE ALUMNO (ID INTEGER NOT NULL, ALUMNOMOVILIDAD BOOLEAN, CODIGOPOSTAL INTEGER, DNI VARCHAR UNIQUE, DIRECCION VARCHAR, EMAIL_INSTITUCIONAL VARCHAR NOT NULL, EMAIL_PERSONAL VARCHAR, LOCALIDAD VARCHAR, MOVIL VARCHAR, NOMBRE_COMPLETO VARCHAR NOT NULL, PROVINCIA VARCHAR, TELEFONO VARCHAR, GRUPOS_ASIGNADOS LONGVARBINARY, LOGIN_CODIGO INTEGER, PRIMARY KEY (ID))
