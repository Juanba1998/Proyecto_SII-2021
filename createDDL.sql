CREATE TABLE ALUMNO (ID INTEGER NOT NULL, ALUMNOMOVILIDAD BOOLEAN, CODIGOPOSTAL INTEGER, DNI VARCHAR UNIQUE, DIRECCION VARCHAR, EMAIL_INSTITUCIONAL VARCHAR NOT NULL, EMAIL_PERSONAL VARCHAR, LOCALIDAD VARCHAR, MOVIL INTEGER, NOMBRE_COMPLETO VARCHAR NOT NULL, PROVINCIA VARCHAR, TELEFONO INTEGER, LOGIN_CODIGO INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE LOGIN (CODIGO INTEGER NOT NULL, CONTRASENA VARCHAR NOT NULL, USUARIO VARCHAR NOT NULL, ESALUMNO BOOLEAN NOT NULL, ALUMNO_ID INTEGER, PRIMARY KEY (CODIGO))
CREATE TABLE MATRICULA (CURSO_ACADEMICO VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHA_DE_MATRICULA DATE NOT NULL, LISTADO_ASIGNATURAS VARCHAR, NUEVO_INGRESO BOOLEAN, NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR, EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTE_NUM_EXPEDIENTE))
