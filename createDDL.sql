...
CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, CODIGO INTEGER NOT NULL, CREDITOS INTEGER NOT NULL, CUATRIMESTRE VARCHAR(255), CURSO VARCHAR(255), DURACION VARCHAR(255), IDIOMASDEIMPARTICION VARCHAR(255), NOMBRE VARCHAR(255) NOT NULL, OFERTADOS INTEGER NOT NULL, ASIGNATURAS_TITULACION_CODIGO INTEGER, PRIMARY KEY (REFERENCIA))
...
CREATE TABLE GRUPO (ID INTEGER NOT NULL, ASIGNAR VARCHAR(255), CURSO VARCHAR(255) UNIQUE, INGLES TINYINT(1) default 0 NOT NULL, LETRA VARCHAR(255) UNIQUE, PLAZAS INTEGER, TURNO_MANANA_TARDE VARCHAR(255) NOT NULL, VISIBLE TINYINT(1) default 0, TITULACION_CODIGO INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE OPTATIVAS (REFERENCIA INTEGER NOT NULL, CODIGO INTEGER NOT NULL, CREDITOS INTEGER NOT NULL, CUATRIMESTRE VARCHAR(255), CURSO VARCHAR(255), DURACION VARCHAR(255), IDIOMASDEIMPARTICION VARCHAR(255), MENCION VARCHAR(255), NOMBRE VARCHAR(255) NOT NULL, OFERTADOS INTEGER NOT NULL, PLAZAS INTEGER, ASIGNATURAS_TITULACION_CODIGO INTEGER, PRIMARY KEY (REFERENCIA))
...
CREATE TABLE jnd_titu_cen (titu_fk INTEGER NOT NULL, cen_fk INTEGER NOT NULL, PRIMARY KEY (titu_fk, cen_fk))
...
CREATE TABLE GRUPO_GRUPO (Grupo_ID INTEGER NOT NULL, agrupa_grupos_ID INTEGER NOT NULL, PRIMARY KEY (Grupo_ID, agrupa_grupos_ID))
...
ALTER TABLE OPTATIVAS ADD CONSTRAINT FK_OPTATIVAS_ASIGNATURAS_TITULACION_CODIGO FOREIGN KEY (ASIGNATURAS_TITULACION_CODIGO) REFERENCES TITULACION (CODIGO)
ALTER TABLE jnd_titu_cen ADD CONSTRAINT FK_jnd_titu_cen_titu_fk FOREIGN KEY (titu_fk) REFERENCES TITULACION (CODIGO)
ALTER TABLE jnd_titu_cen ADD CONSTRAINT FK_jnd_titu_cen_cen_fk FOREIGN KEY (cen_fk) REFERENCES CENTRO (ID)
...
ALTER TABLE GRUPO_GRUPO ADD CONSTRAINT FK_GRUPO_GRUPO_agrupa_grupos_ID FOREIGN KEY (agrupa_grupos_ID) REFERENCES GRUPO (ID)
