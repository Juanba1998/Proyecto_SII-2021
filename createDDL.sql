...
CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, DTYPE VARCHAR(31), CARACTER VARCHAR(255), CODIGO INTEGER NOT NULL, CREDITOS INTEGER NOT NULL, CUATRIMESTRE VARCHAR(255), CURSO VARCHAR(255), DURACION VARCHAR(255), IDIOMAS_DE_IMPARTICION VARCHAR(255), NOMBRE VARCHAR(255) NOT NULL, OFERTADA INTEGER NOT NULL, ASIGNATURAS_TITULACION_CODIGOTITULACION INTEGER, PRIMARY KEY (REFERENCIA))
CREATE TABLE TITULACION (CODIGOTITULACION INTEGER NOT NULL, CREDITOS INTEGER NOT NULL, NOMBRE VARCHAR(255) NOT NULL, PRIMARY KEY (CODIGOTITULACION))
...
CREATE TABLE MATRICULA (CURSO_ACADEMICO VARCHAR(255) NOT NULL, ESTADO VARCHAR(255) NOT NULL, FECHA_DE_MATRICULA DATE NOT NULL, LISTADO_ASIGNATURAS VARCHAR(255), NUEVO_INGRESO TINYINT(1) default 0, NUM_ARCHIVO INTEGER, TURNO_PREFERENTE VARCHAR(255), EXPEDIENTE_NUM_EXPEDIENTE INTEGER NOT NULL, PRIMARY KEY (CURSO_ACADEMICO, EXPEDIENTE_NUM_EXPEDIENTE))
...
CREATE TABLE GRUPO (ID INTEGER NOT NULL, ASIGNAR VARCHAR(255), CURSO VARCHAR(255) UNIQUE, INGLES TINYINT(1) default 0 NOT NULL, LETRA VARCHAR(255) UNIQUE, PLAZAS INTEGER, TURNO_MANANA_TARDE VARCHAR(255) NOT NULL, VISIBLE TINYINT(1) default 0, ID_GRUPO_ID INTEGER, TITULACION_CODIGOTITULACION INTEGER, PRIMARY KEY (ID))
